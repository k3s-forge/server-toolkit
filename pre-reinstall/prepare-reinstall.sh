...
create_reinstall_guide() {
    ...
    
    {
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/YOUR_ORG/server-toolkit/main/bootstrap.sh | bash"
        echo ""
        ...
        echo ""
        echo "=== Support ==="
        echo "- Documentation: https://github.com/YOUR_ORG/server-toolkit"
        echo "- Issues: https://github.com/YOUR_ORG/server-toolkit/issues"
        echo ""
    } > "$guide_file"
