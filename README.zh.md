...
此功能生成用于重装服务器操作系统的自动化脚本。它会：
- 收集当前系统信息（操作系统、网络、硬件）
- 创建可自定义的重装脚本
- 生成详细的重装指南
- 集成 [bin456789/reinstall](https://github.com/bin456789/reinstall) 工具

**使用场景**：
- 更换操作系统（Ubuntu → Debian、CentOS → Rocky Linux）
- 清洁系统安装
- 多台服务器的标准化部署

**重要**：这是用于操作系统重装，不是系统恢复。详见 [REINSTALL-SCRIPT-GUIDE.md](REINSTALL-SCRIPT-GUIDE.md)。
